...
This tutorial demonstrates how to visualize the UGE atlas via UMAP and harmonize disparate cell type labels across datasets using unsupervised clustering and majority voting.
...
.. toctree::
   ...
   vignettes/UGEatlas_celltype_harmonization.ipynb

...
import sys
# sys.path.append('/home/xwanaf/superpod/gene_pert')
...
class TransformerVAEModel_pl(pl.LightningModule):
    def __init__(
        self,
        d_model: int,
        nhead: int,
        ...
        self.test_use_common_gene = None
...
#                 self.logger.log_info(f'Subsampling background_adata ...')
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx = 0):  
        ...
        if dataloader_idx == 0: # out of sample
            ...
            output_dict = self.p_losses_test(batch)
    ...
    def on_validation_epoch_end(self): 
        ...
        def plot_cell_sample(cell_id, celltype_column, sample_cells, sample_cell_embs, CellTypeMapping_df, suffix = None, background_adata = None, testDS = False):
            ...
            celltype_column = CellTypeMapping_df.iloc[celltypes]['cell_type'].tolist()
        ...
        plot_cell_sample(
            ...
            background_adata = self.background_adatas[0],
        )
    ...
    def p_losses_test(self, batch):
        ...
        bs, max_len = data_dict['gene'].shape
        ...
        data_dict['gene'], data_dict['expr'] = self._pad(data_dict['gene'], data_dict['expr'], max_length)
        if True: #self.training:
            new_gene_shape = data_dict['gene'].shape

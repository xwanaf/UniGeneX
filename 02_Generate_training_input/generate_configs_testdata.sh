...
base_path="/project/spatomics/maxwan/gene_pert/lung_HLCAbench_v2_data/test_data"
traingene_path="/project/spatomics/maxwan/gene_pert/lung_HLCAbench_v2_data/pretrain_data"



python generate_configs.py \
--config_temp_path /home/share/xwanaf/Img2Expr/data/lung_HLCA/Xenium_Vannan/configs/config_templete.yaml \
--save_path /import/home2/xwanaf/Img2Expr/data/lung_HLCAbench/subsample/fraction_g00_r50 \
--save_config_name config_inference \
--vocab_path $traingene_path/default_census_vocab.json \
--common_dec_gene_len 1703 \
--CellTypeMapping_df_paths $base_path/CellTypeMapping_df.csv \
--data_source $base_path/cls_prefix_data.parquet \
--test_out_of_sample_data_source $base_path/cls_prefix_data.parquet \
--common_dec_genes_path $traingene_path/pretrain_data_train_genes.npy \
--gpus 0,1,2,3 \
--devices 1
...
# python generate_configs.py \
# --config_temp_path /home/share/xwanaf/Img2Expr/data/lung_HLCA/Xenium_Vannan/configs/config_templete.yaml \
# --save_path /home/share/xwanaf/Img2Expr/data/lung_HLCA/Xenium_Vannan/configs_addIPF_1k \
# --save_config_name config_$adata \
# --vocab_path $base_path/pretrain_data/default_census_vocab.json \
# --common_dec_gene_len 1258 \
# --CellTypeMapping_df_paths $base_path/Vannan/$adata/CellTypeMapping_df.csv \
# --data_source $base_path/Vannan/$adata/cls_prefix_data.parquet \
# --test_out_of_sample_data_source $base_path/Vannan/$adata/cls_prefix_data.parquet \
# --common_dec_genes_path $base_path/pretrain_data/pretrain_data_train_genes.npy \
# --gpus 0,1,2,3,4,5,6,7 \
# --devices 1
